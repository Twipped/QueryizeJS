...
var mysqlDate = require('./mysqldate');
 ...
 *
 * @deprecated as of version 2.2, will be removed in 3.0
 * @memberOf query
 * @category Evaluation
 ...
 * @param  {...[mixed]} args Any options to be passed to the evalFunction
 * @return {Promise}
 */
 ...
 * Compiles the MySQL query and executes it using `queryize.evalFunction`, returning a promise.
 * If no eval function has been defined, the promise resolves with a tuple of the query string and data array.
 * @param  {function} resolved Function to execute when the evaluation completes
 * @param  {function} rejected Function to execute if the evaluation fails
 * @return {Promise}
 */
