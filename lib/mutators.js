 ...
 *   .compile()
 */
query.select = function select (columns) {
 ...
 *   .compile()
 */
query.deleteFrom = exports.deleet = exports.delete = function deleteFrom (tablename, alias) {
 ...
 *   })
 */
query.insert = function insert (values) {
 ...
 */
query.orderBy = function orderBy (columns) {
	var args = flatten(arrayFromArguments.apply(null, arguments));
 ...
 */
query.groupBy = function groupBy (columns) {
	var args = flatten(arrayFromArguments.apply(null, arguments));
 ...
 * @return {query} Exports `this` for chaining
 */
query.useBoundParameters = function useBoundParameters (on) {
